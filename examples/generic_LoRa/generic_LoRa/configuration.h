...
#define SEND_INTERVAL_STATIC    45000       // Tiempo de espera entre mensajes SI NO SE HABILITA EL VSI
#define SEND_INTERVAL_RELAXED   60000       // Tiempo de espera entre mensajes cuando la distancia varia poco entre medidas SI SE HABILITA EL VSI
...
#define RX_PIN          3                   // Pin RX del ESP32 al pin TX del sensor
#define TX_PIN          1                   // Pin TX del ESP32 al pin RX del sensor
#define VBAT_PIN        34                  // Pin al que conecto la batería para medir su voltaje
#define TX_BUFFER_SIZE  15                   // Tamaño del buffer de bytes a enviar a TTN
#define TARGET_ARRAY_LENGTH 10              // Tamaño del Buffer Circular
#define SEALEVELPRESSURE_HPA (1015)         // Referencia de presion a nivel de mar